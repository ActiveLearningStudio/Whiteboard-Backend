...
/**
 * Store log information in logs collection
 */
...
/**
 * Find perticuler log by using module 
 * If log is find then send log information to user
 */
...
/**
 * Find perticuler log by using logLevel 
 * If log is find then send log information to user
 */
...
/**
 * Find perticuler log by using trasactionId 
 * If log is find then send log information to user
 */
...
/**
 * Find perticuler log by using module and loglevel
 * If log is find then send log information to user
 */
